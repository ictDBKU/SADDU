...
<div align="center" id="table2" >
    ...
    <td> <?php echo $no++; ?></td>
      <td><?php if($row_ViewAduan['ReadStatus']==1){?>
        ...
        <td><?php echo $row_MyAduan['StatusAduan']; ?></td>
        <td><?php echo date("d/m/Y  ", strtotime($row_MyAduan['TimeSubmit']) ); ?><br>
        <?php echo date("h:i:sa  ", strtotime($row_MyAduan['TimeSubmit']) ); ?></td>
